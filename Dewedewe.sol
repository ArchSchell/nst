/**
 *Submitted for verification at BscScan.com on 2024-11-01
*/
...
contract DewedeweToken is ERC20, Pausable, ReentrancyGuard, Ownable {
    uint256 public constant INITIAL_SUPPLY = 1_000_000_000 * 10 ** 18; // 1 billion tokens with 18 decimals

    constructor() ERC20("Dewedewe", "ORI") Ownable(msg.sender) {
    ...
    // Standard BEP-20 functions with Pausable and Reentrancy Guard
    ...
    // Token burn function to reduce total supply
    function burn(uint256 amount) external whenNotPaused nonReentrant {
        _burn(msg.sender, amount);
    }

    // Define token decimals as 18
